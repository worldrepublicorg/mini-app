          ...
          <div className="flex w-full flex-col items-center py-8">
            ...
            >
              ...
              <span className="group relative inline-flex items-center align-baseline">
                ...
                <div className="absolute bottom-full right-0 mb-2 hidden w-[calc(100dvw/2)] transform rounded-lg border border-gray-200 bg-gray-0 p-3 text-xs shadow-lg group-hover:block">
